...
namespace plog
{
template <int instanceId> class PLOG_LINKAGE Logger : public util::Singleton<Logger<instanceId>>, public IAppender
{
  public:
...
template <int instanceId> inline Logger<instanceId> *get()
{
