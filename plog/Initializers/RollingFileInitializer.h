...
PLOG_LINKAGE_HIDDEN inline Logger<instanceId> &init(Severity maxSeverity, const util::nchar *fileName,
                                                    size_t maxFileSize = 0, int maxFiles = 0)
{
...
inline Logger<PLOG_DEFAULT_INSTANCE_ID> &init(Severity maxSeverity, const util::nchar *fileName, size_t maxFileSize = 0,
                                              int maxFiles = 0)
{
...
inline Logger<instanceId> &init(Severity maxSeverity, const util::nchar *fileName, size_t maxFileSize = 0,
                                int maxFiles = 0)
{
    return isCsv(fileName) ? init<CsvFormatter, instanceId>(maxSeverity, fileName, maxFileSize, maxFiles)
...
template <class Formatter>
inline Logger<PLOG_DEFAULT_INSTANCE_ID> &init(Severity maxSeverity, const char *fileName, size_t maxFileSize = 0,
                                              int maxFiles = 0)
{
    return init<Formatter, PLOG_DEFAULT_INSTANCE_ID>(maxSeverity, fileName, maxFileSize, maxFiles);
}
